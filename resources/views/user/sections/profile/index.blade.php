                        ...
                        <div class="dashboard-btn-wrapper">
                            <div class="dashboard-btn">
                                <button type="button" class="btn--base bg--danger" data-bs-toggle="modal"
                                    data-bs-target="#deleteModal">{{ __('Delete Profile') }}</button>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="preview-thumb profile-wallpaper">
                                    <div class="avatar-preview">
                                        <div class="profilePicPreview bg_img"
                                            data-background="{{ get_image('frontend/images/element/banner-bg.png') }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="preview-thumb profile-thumb">
                                        ...
                                        <div class="avatar-edit">
                                            <input type='file' class="profilePicUpload" name="image"
                                                id="profilePicUpload2" accept=".png, .jpg, .jpeg, .webp, .svg" />
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>{{ __('If you do not think you will use') }} “{{ $basic_settings->site_name }}”
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn--base" data-bs-dismiss="modal"

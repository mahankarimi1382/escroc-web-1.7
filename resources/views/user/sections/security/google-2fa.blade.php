                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-text copytext" id="copyBoard"><i class="las la-copy"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-12 col-lg-12 form-group">
                            ...
                            <div class="col-xl-12 col-lg-12">
                                @if (auth()->user()->two_factor_status)
                                    ...
                                    <div class="text--danger mt-3">
                                        {{ __("Don't forget to add this application in your google authentication app. Otherwise, you can't login to your account") }}
                                    </div>
                                @else
                                    <button type="button"
                    ...
                    <div class="card-body">
                        ...
                        <p>{{ __('Google Authenticator is a product based authenticator by Google that executes two-venture confirmation administrations for verifying clients of any programming applications') }}.
                            <a href="https://support.google.com/accounts/answer/1066447?hl=en&co=GENIE.Platform=Android"
                                class="how_to_setup_btn" target="_blanck">{{ __('How to setup') }}?</a></p>
                        <div class="play-store-thumb text-center mb-20">
                            <img class="mx-auto" src="{{ asset('frontend/') }}/images/element/google-authenticator.webp">
                        </div>

                    ...
                    <form class="card-form" action="{{ setRoute("user.money.out.confirm.automatic") }}" method="POST" enctype="multipart/form-data">
                        ...
                        {{-- <div class="row">
                            ...
                            <div class="branches-list">
                                @if($branch_status)
                                    <div class="col-lg-12 form-group">
                                        <label for="branch_code">{{ __("Bank Branch") }} <span>*</span></label>
                            ...
                            <div class="col-lg-12 form-group">
                                <label for="beneficiary_name">{{ __("Beneficiary Name") }} <span>*</span></label>
                        ...
                        <div class="preview-list-wrapper">
                            <div class="preview-list-item">
                                ...
                                <div class="preview-list-right">
                                    <span class="request-amount">{{ number_format(@$moneyOutData->amount,2 )}} {{ @$moneyOutData->sender_currency }}</span>
                                </div>
                            </div>
                            <div class="preview-list-item">
                                <div class="preview-list-left">
                                ...
                                <div class="preview-list-right">
                                    <span class="request-amount">{{ __("1") }} {{ @$moneyOutData->sender_currency }} =  {{ number_format(@$moneyOutData->gateway_rate,2 )}} {{ @$moneyOutData->gateway_currency }}</span>
                                </div>
                            </div>
                            <div class="preview-list-item">
                                <div class="preview-list-left">
                            ...
                            <div class="preview-list-item">
                                ...
                                <div class="preview-list-right">
                                    <span class="text--warning last">{{ number_format(@$moneyOutData->payable,2 )}} {{ @$moneyOutData->sender_currency }}</span>
                                </div>
                            </div>
                        </div>
                    </div>

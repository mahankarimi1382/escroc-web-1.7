    <div class="col-12 col-lg-12 form-group">
        ...
        <select name="bank_name" id="bank_name" class="form--control select2-basic"  data-placeholder="{{ __("Select Bank") }}" >
    ...
    <div class="col-12 col-lg-6 form-group">
        ...
        <select name="beneficiary_country" id="beneficiary_country" class="form--control select2-basic"  data-placeholder="{{ __("Select Beneficiary Country") }}" >

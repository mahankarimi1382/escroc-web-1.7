    ...
    <div class="row mb-30-none justify-content-center">
        <div class="col-lg-6">
            <div class="custom-card">
                ...
                <div class="card-body">
                    <form id="payment-form" action="{{ setRoute('user.escrow-action.authorize.payment.submit',$tempData->identifier) }}" method="post" class="checkout-form" novalidate>
                        @csrf
                        ...
                        <div class="preview-list-wrapper">
                            <div class="preview-list-item">
                                ...
                                <div class="preview-list-right">
                                    <span class="text--warning">{{ get_amount($escrowDetails->fee??"", $escrow->escrow_currency??"") }}</span>
                                </div>
                            </div>
                            <div class="preview-list-item">
                                <div class="preview-list-left">
                                ...
                                <div class="preview-list-right">
                                    <span>{{ get_amount($escrowDetails->seller_get, $escrow->escrow_currency) }}</span>
                                </div>
                            </div>
                            <div class="preview-list-item">
                                <div class="preview-list-left">
                                ...
                                <div class="preview-list-right">
                                    <span>{{ $tempData->gateway_currency->name }}</span>
                                </div>
                            </div>
                            <div class="preview-list-item">
                                <div class="preview-list-left">
                                ...
                                <div class="preview-list-right">
                                    <span>1 {{ $tempData->escrow->escrow_currency??"" }} = {{ get_amount($tempData->escrow->eschangeRate??"",$tempData->gateway_currency->currency_code??"") }}</span>
                                </div>
                            </div>
                            <div class="preview-list-item">
                                <div class="preview-list-left">
                                ...
                                <div class="preview-list-right">
                                    <span class="text--info last">{{ get_amount($tempData->escrow->buyer_amount??"",$tempData->gateway_currency->currency_code??"")}}</span>
                                </div>
                            </div> 
                        </div>
                    </div>

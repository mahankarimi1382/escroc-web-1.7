@if (admin_permission_by_name("admin.blog.store"))
<div id="blog-add" class="mfp-hide large">
    <div class="modal-data">
        ...
        <div class="modal-form-data">
            <form class="modal-form" method="POST" action="{{ setRoute('admin.blog.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="row mb-10-none mt-3">
                    <div class="col-xl-12 col-lg-12 form-group">
                        <label>{{ __("Blog Category*") }}</label>
                        <select name="category_id" id="category" class="form--control nice-select" required>

...
@section('content')
    <div class="custom-card">
        ...
        <div class="card-body">
            <form class="modal-form" method="POST" action="{{ setRoute('admin.useful.links.update') }}"
                ...
                <div class="row mb-10-none mt-3">
                    ...
                    <div class="col-xl-12 col-lg-12 form-group d-flex align-items-center justify-content-between mt-4">
                        <a href="{{ setRoute('admin.useful.links.index') }}"
                            class="btn btn--danger modal-close">{{ __('Cancel') }}</a>

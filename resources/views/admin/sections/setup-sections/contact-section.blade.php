                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane @if (get_default_language_code() == language_const()::NOT_REMOVABLE) fade show active @endif"
                                    ...
                                    <div class="form-group">
                                        @include('admin.components.form.input', [
                                            'label' => __('Title') . '*',
                                            'name' => $default_lang_code . '_right_title',
                                            'value' => old(
                                                $default_lang_code . '_right_title',
                                                $data->value->language->$default_lang_code->right_title ?? ''),
                                        ])
                                    </div>
                                    <div class="form-group">
                                        @include('admin.components.form.textarea', [
                                            ...
                                            'value' => old(
                                                $default_lang_code . '_right_details',
                                                $data->value->language->$default_lang_code->right_details ?? ''),
                                        ])
                                    </div>
                                </div>
                                ...
                                @foreach ($languages as $item)
                                    ...
                                    <div class="tab-pane @if (get_default_language_code() == $item->code) fade show active @endif"
                                        ...
                                        <div class="form-group">
                                            @include('admin.components.form.input', [
                                                'label' => __('Title') . '*',
                                                'name' => $lang_code . '_right_title',
                                                'value' => old(
                                                    $lang_code . '_right_title',
                                                    $data->value->language->$lang_code->right_title ?? ''),
                                            ])
                                        </div>
                                        <div class="form-group">
                                            @include('admin.components.form.textarea', [
                                                ...
                                                'value' => old(
                                                    $lang_code . '_right_details',
                                                    $data->value->language->$lang_code->right_details ?? ''),
                                            ])
                                        </div>
                                    </div>
                                @endforeach

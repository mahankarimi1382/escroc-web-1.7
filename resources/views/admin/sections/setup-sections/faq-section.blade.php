                                ...
                                <div class="tab-pane @if (get_default_language_code() == language_const()::NOT_REMOVABLE) fade show active @endif"
                                    ...
                                    <div class="form-group">
                                        @include('admin.components.form.input', [
                                            ...
                                            'value' => old(
                                                $default_lang_code . '_question_edit',
                                                $data->value->language->$default_lang_code->question ?? ''),
                                        ])
                                    </div>
                                    ...
                                    <div class="form-group">
                                        @include('admin.components.form.textarea', [
                                            ...
                                            'value' => old(
                                                $default_lang_code . '_answer_edit',
                                                $data->value->language->$default_lang_code->answer ?? ''),
                                        ])
                                    </div>

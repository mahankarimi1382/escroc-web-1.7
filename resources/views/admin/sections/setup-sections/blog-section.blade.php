                            ...
                            <tbody>
                                @forelse ($blogs?? [] as $key => $item)
                                    <tr data-item="{{ $item }}">
                                        ...
                                        <td>{{ textLength($item->name->language->$system_default_lang->name ?? '', 60) }}
                                        </td>
                                        <td>
    ...
    <script>
        ...
        $(".edit-modal-button").click(function() {
            ...
            $.each(languages, function(index, item) {
                ...
                editModal.find("input[name=" + item.code + "_name]").val(oldData.name.language[item.code]
                    ?.name);
                editModal.find("textarea[name=" + item.code + "_details]").val(oldData.details.language[item
                    .code]?.details);

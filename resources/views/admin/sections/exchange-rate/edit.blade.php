                        ...
                        <div class="row" >
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 form-group">
                                ...
                                <div class="input-group append">
                                    ...
                                    <input type="text" class="form--control number-input" name="multiply_by" value="{{get_amount($provider->multiply_by,null)}}">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-8 mb-30">
                            <div class="custom-inner-card">
                                <div class="card-inner-body">
                                    <b class="d-block mb-3">{{ __("Supported Currencies")}} : {{ count(updateAbleCurrency()['matching_currencies']) }}</b>
...
@push('script')
    ...
    //         (mByValue == "" ||  isNaN(mByValue) || mByValue > 2 || mByValue == 0 ) ? mByValue = "{{get_amount($provider->multiply_by,null)}}" : mByValue = mByValue;

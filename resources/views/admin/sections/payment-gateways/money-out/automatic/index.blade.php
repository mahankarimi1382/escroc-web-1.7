            ...
            <div id="p-gateway-automatic-add" class="mfp-hide large">
                <div class="modal-data">
                    <div class="modal-header">
                        <h5 class="modal-title">{{ __("Add Automatic Gateway (Withdraw)") }}</h5>
                    </div>
                    <div class="modal-form-data">
                        <form class="modal-form" method="POST" action="{{ setRoute('admin.payment.gateway.store',['withdraw','automatic']) }}" enctype="multipart/form-data">
                            @csrf

...
@section('content')
                    ...
                    <div class="about-content">
                        ...
                        <ul class="about-list">
                            @foreach ($about->value->items ?? [] as $key => $item)
                                <li><i class="{{ $item->icon ?? 'fas fa-check' }}"></i>
                                    {{ $item->language->$defualt->title ?? '' }}</li>
                            @endforeach
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-xl-5 col-lg-6 text-center">
                    <div class="section-header">
                        <span class="section-sub-title"><span
                                class="gradient-text">{{ @$service->value->language->$defualt->heading }}</span></span>
                ...
                <div class="col-xl-6 col-lg-6 mb-30">
                    <div class="feature-content-wrapper">
                        <div class="feature-content-header">
                            <span
                                class="sub-title gradient-text">{{ $feature->value->language->$defualt->heading ?? '' }}</span>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-7 col-lg-7 text-center">
                    <div class="section-header">
                        <span class="section-sub-title"><span
                                class="gradient-text">{{ $testimonial->value->language->$defualt->heading ?? '' }}</span></span>
                                            ...
                                            <div class="testimonial-content">
                                                ...
                                                <div class="testimonial-user-wrapper">
                                                    <div class="testimonial-user-thumb">
                                                        <img src="{{ get_image($item->user_image ?? '', 'site-section') }}"
                                                            alt="user">
                                                    </div>
    ...
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            ...
            ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    @php
        $blogPage = App\Models\Admin\SetupPage::where(['type' => 'setup-page', 'status' => true])
            ->Where('slug', 'blogs')
            ->first();
    @endphp
    @if ($blogPage != null)
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-30">
                            <div class="blog-item">
                                <div class="blog-thumb">
                                    ...
                                    <div class="blog-tags">
                                        <a href="{{ setRoute('blog.by.category', [$item->category->id, $item->category->slug]) }}"
                                ...
                                <div class="blog-content">
                                    ...
                                    <h3 class="title"><a
                                            href="{{ route('blog.details', [$item->id, $item->slug]) }}">{{ @$item->name->language->$defualt->name }}</a>
                                    </h3>
                                    <div class="blog-btn">
                                        <a href="{{ route('blog.details', [$item->id, $item->slug]) }}"
                                            class="custom-btn">{{ __('Read More') }} <i

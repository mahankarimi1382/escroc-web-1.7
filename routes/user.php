...
Route::prefix("user")->name("user.")->group(function(){
    ...
    Route::controller(EscrowController::class)->name('my-escrow.')->group(function(){
        ...
        // authorize payment
        Route::get('authorize-card-info-submit/{trx}','authorizeCardInfo')->name('authorize.card.info.web');
        Route::post('authorize-payment-submit-web/{identifier}','authorizePaymentSubmit')->name('authorize.payment.submit.web');
    });
    ...
    Route::controller(EscrowActionsController::class)->name('escrow-action.')->group(function(){
        ...
        // authorize payment
        Route::get('authorize-card-info/{trx}','authorizeCardInfo')->name('authorize.card.info');

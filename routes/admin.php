...
Route::name('admin.')->group(function () {
    Route::middleware(['web', 'guest', 'admin.login.guard'])->group(function () {
        ...
        Route::controller(AuthorizationController::class)->prefix("authorize")->middleware(['auth:admin'])->withoutMiddleware(['admin.login.guard', 'guest'])->name('authorize.')->group(function () {

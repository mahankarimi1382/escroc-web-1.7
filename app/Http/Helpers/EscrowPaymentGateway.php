...
use App\Traits\EscrowPaymentGateway\Authorize;
...
class EscrowPaymentGateway {
    use Paypal, Stripe, FlutterwaveTrait, Manual, RazorTrait, SslcommerzTrait,QrpayTrait,CoinGate,PagaditoTrait,PerfectMoney,Tatum,PaystackTrait,Authorize;
